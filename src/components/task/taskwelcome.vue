	...
	<div class="header2" id="demo">
		...
		<div class="entrance">
			<ul class="clearfix">
				...
				<li>
					<img src="/static/images/go.png" @click="routeGo(0)">
				</li>
			</ul>
		</div>
	</div>
...
<style scope>
	...
	.header2 .entrance ul li:nth-child(2){
		float: right;
		width: 200px;
	}
	.header2 .entrance ul li img{
		width: 100%;
	}
</style>
 <script>
